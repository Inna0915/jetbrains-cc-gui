...
**Goal:** Add Antigravity (`agy`) as a first-class provider using the real `google-antigravity` Python SDK, including provider switching, SDK dependency management, streaming, session resume, and permission-mode switching.
