            ...
            try {
                ...
                if (saved != null && !saved.trim().isEmpty()) {
                    ...
                    if (result != null && result.isFound()) {
                        ...
                        if (this.context.getAgySDKBridge() != null) {
                            this.context.getAgySDKBridge().setNodeExecutable(null);
                        }
                        ...
                        if (detected != null && detected.isFound() && detected.getNodePath() != null) {
                            ...
                            if (this.context.getAgySDKBridge() != null) {
                                this.context.getAgySDKBridge().setNodeExecutable(pathToSend);
                            }
                        }
                    }
                } else {
                    ...
                    if (detected != null && detected.isFound() && detected.getNodePath() != null) {
                        ...
                        if (context.getAgySDKBridge() != null) {
                            context.getAgySDKBridge().setNodeExecutable(pathToSend);
                        }
                    }
                }
        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                if (pathArg == null || pathArg.isEmpty()) {
                    ...
                    if (context.getAgySDKBridge() != null) {
                        context.getAgySDKBridge().setNodeExecutable(null);
                    }
                    ...
                    if (detected != null && detected.isFound() && detected.getNodePath() != null) {
                        ...
                        if (context.getAgySDKBridge() != null) {
                            context.getAgySDKBridge().setNodeExecutable(finalPath);
                        }
                        verifySuccess = true;
                    } else {
                    ...
                    if (result != null && result.isFound()) {
                        ...
                        if (context.getAgySDKBridge() != null) {
                            context.getAgySDKBridge().setNodeExecutable(pathArg);
                        }
                        finalPath = pathArg;
                        versionToSend = result.getNodeVersion();
                        verifySuccess = true;
